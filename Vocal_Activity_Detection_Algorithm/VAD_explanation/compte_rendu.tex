...
\subsubsubsection{Segmentation}\footnote{L'idée s'appuit sur le principe des bufferisation que l'on utilise couramment en temps réel pour stocker nos données que l'on acquisitionne. Notamment en ce qui concerne les appelations "head" et "tail"}
