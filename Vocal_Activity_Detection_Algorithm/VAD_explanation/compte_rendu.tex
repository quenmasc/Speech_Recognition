...
Le ZRC compte le nombre de passage par zéro du signal. Les trames de voisées\cite{voisée} ont un taux de passage à zéro faible alors l'inverse des trames non voisées qui ont un ZRC élevé . On peut définir le ZRC de la manière suivante :
\begin{equation}
