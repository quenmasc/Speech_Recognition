...
\end{figure}
\newpage
\paragraph{Signal avec un SNR de $-30dB$}
...
\subparagraph{Retour à notre algorithme}
...
\paragraph{Notre morceau avec une musique de fond}
